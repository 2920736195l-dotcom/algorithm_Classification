...
import argparse
import os
os.environ["GIT PYTHON REFRESH"] = "quiet"
import subprocess
import sys
import time
...
def parse_opt(known=False):
    ...
    parser.add_argument('--model', type=str, default=r"D:\yolov5-7.0\yolov5s-cls.pt", help='initial weights path')
    parser.add_argument('--data', type=str, default=r"E:\dataset\gw-all-0526", help='cifar10, cifar100, mnist, imagenet, ...')
    ...
    parser.add_argument('--name', default='gw-0527-all', help='save to project/name')
